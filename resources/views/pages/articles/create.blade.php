...
@section('header')
	<x-main.header title="Buat Artikel" :back="route('articles.index')" />
@endsection
@push('css')
...
@section('content')
	...
	<section>
		<form action="{{ route('articles.store') }}" method="POST" enctype="multipart/form-data">
			@csrf
			<x-form.input class="mb-5" name="title" label="Judul Artikel" placeholder="Isi judul artikel" />
			...
			<div class="mb-5">
				...
				<textarea name="content" class="hidden" id="input-content">{{ old('content') }}</textarea>
